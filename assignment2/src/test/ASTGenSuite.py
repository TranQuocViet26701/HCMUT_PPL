    ...
    main()
        {
            Foreach (i In 1 .. 100 By -1) {}
                ...
                """
        expect = "Program([ClassDecl(Id(Test),[MethodDecl(Id(main),Instance,[],Block([For(Id(i),IntLit(1),IntLit(100),UnaryOp(-,IntLit(1)),Block([])])]))])])"
    ...
    main()
        {
            Foreach (i In 1 .. 5 + 1) {
                ...
                """
        expect = "Program([ClassDecl(Id(Test),[MethodDecl(Id(main),Instance,[],Block([For(Id(i),IntLit(1),BinaryOp(+,IntLit(5),IntLit(1)),IntLit(1),Block([Call(Id(IO),Id(printf),[Id(i)])])])]))])])"
    ...
    main()
        {
            ...
            Foreach (i In 1 .. x) {
                ...
                """
        expect = "Program([ClassDecl(Id(Test),[MethodDecl(Id(main),Instance,[],Block([VarDecl(Id(x),IntType),Call(Id(IO),Id(input),[Id(x)]),For(Id(i),IntLit(1),Id(x),IntLit(1),Block([If(BinaryOp(==,BinaryOp(%,Id(i),IntLit(2)),IntLit(1)),Block([Call(Id(IO),Id(print),[Id(i)])])),If(BinaryOp(==,Id(i),IntLit(4)),Block([Break]))])])]))])])"
...
Class Test {
    main()
        {
            ...
            Foreach (i In 1 .. x) {
                ...
                """
        expect = "Program([ClassDecl(Id(Test),[MethodDecl(Id(main),Instance,[],Block([VarDecl(Id(x),IntType),Call(Id(IO),Id(input),[Id(x)]),For(Id(i),IntLit(1),Id(x),IntLit(1),Block([If(BinaryOp(==,BinaryOp(%,Id(i),IntLit(2)),IntLit(1)),Block([Call(Id(IO),Id(print),[Id(i)])])),If(BinaryOp(==,Id(i),BinaryOp(/,Id(x),IntLit(2))),Block([AssignStmt(Id(i),BinaryOp(+,Id(i),IntLit(5))),Continue]))])])]))])])"
    ...
    def test24(self):
        ...
        expect = "Program([ClassDecl(Id(testFor),[MethodDecl(Id(testFor),Instance,[],Block([For(Id(i),IntLit(1),IntLit(10),IntLit(1),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1)))])])])),MethodDecl(Id(callFor),Instance,[],Block([For(Id(i),IntLit(25),IntLit(5),IntLit(2),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1))),For(Id(i),IntLit(5),IntLit(25),IntLit(2),Block([AssignStmt(ArrayCell(FieldAccess(Id(a),Id(Pi)),[IntLit(5)]),BinaryOp(+,IntLit(1),IntLit(2)))])])])]),Return(Id(a))]))])])"
    ...
    def test25(self):
        ...
        expect = "Program([ClassDecl(Id(testFor),[MethodDecl(Id(testFor),Instance,[],Block([For(Id(i),IntLit(1),IntLit(10),IntLit(1),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1)))])])])),MethodDecl(Id(callFor),Instance,[param(Id(a),IntType)],Block([For(Id(a),IntLit(1),IntLit(10),IntLit(1),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1))),For(Id(a),UnaryOp(-,IntLit(10)),IntLit(10),IntLit(5),Block([AssignStmt(ArrayCell(FieldAccess(Id(a),Id(Pi)),[IntLit(5)]),BinaryOp(+,IntLit(1),IntLit(2))),If(BinaryOp(<,FieldAccess(Id(a),Id(v)),ArrayCell(Id(z),[IntLit(2)])),Block([If(BinaryOp(==,Id(a),IntLit(1)),Block([If(BinaryOp(==,Id(a),IntLit(1)),Block([]))]),Block([If(BinaryOp(>,Id(a),Id(b)),Block([AssignStmt(Id(a),IntLit(2))]),If(BinaryOp(==,Id(a),UnaryOp(-,IntLit(5))),Block([AssignStmt(Id(a),IntLit(2))])))]))]))])])])])]))])])"
    ...
    def test26(self):
        ...
        expect = "Program([ClassDecl(Id(testFor),Id(_parentTest),[MethodDecl(Id(testFor),Instance,[param(Id(i),FloatType)],Block([For(Id(i),IntLit(1),IntLit(10),IntLit(1),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1)))])]),Return(Id(_123))])),MethodDecl(Id($callFor),Static,[],Block([For(Id(i),BinaryOp(-,IntLit(10),IntLit(5)),IntLit(10),UnaryOp(-,IntLit(5)),Block([AssignStmt(Id(a),BinaryOp(+,Id(a),IntLit(1))),For(Id(i),IntLit(1),IntLit(10),BinaryOp(-,IntLit(10),IntLit(5)),Block([AssignStmt(ArrayCell(FieldAccess(Id(a),Id(Pi)),[IntLit(5)]),BinaryOp(+,IntLit(1),IntLit(2)))])])])])]))])])"
    ...
    def test30(self):
        ...
        expect = "Program([ClassDecl(Id(testData),Id(PPL),[MethodDecl(Id(loopTest),Instance,[param(Id(a),IntType),param(Id(v),IntType),param(Id(c),FloatType),param(Id(d),FloatType),param(Id(a),BoolType),param(Id(s),BoolType),param(Id(str1),StringType),param(Id(str2),StringType),param(Id(r1),ClassType(Id(Room))),param(Id(r2),ClassType(Id(Room)))],Block([For(Id(i),BinaryOp(==,BinaryOp(-,BinaryOp(+,Id(a),Id(c)),Id(d)),Id(f)),BinaryOp(+,Id(a),BinaryOp(/,BinaryOp(>=,Id(a),Id(d)),IntLit(32))),BinaryOp(-,IntLit(10),IntLit(5)),Block([If(BinaryOp(>,Id(a),BinaryOp(-,Id(f),IntLit(1))),Block([Break]),Block([Continue])),For(Id(i),BinaryOp(==,BinaryOp(-,BinaryOp(+,Id(a),Id(c)),Id(d)),Id(f)),BinaryOp(+,Id(a),BinaryOp(/,BinaryOp(>=,Id(a),Id(d)),IntLit(32))),BinaryOp(-,IntLit(10),IntLit(5)),Block([If(BinaryOp(>,Id(a),BinaryOp(-,Id(f),IntLit(1))),Block([For(Id(i),BinaryOp(==,BinaryOp(-,BinaryOp(+,Id(a),Id(c)),Id(d)),Id(f)),BinaryOp(+,Id(a),BinaryOp(/,BinaryOp(>=,Id(a),Id(d)),IntLit(32))),BinaryOp(-,IntLit(10),IntLit(5)),Block([If(BinaryOp(>,Id(a),BinaryOp(-,Id(f),IntLit(1))),Block([Call(Id(Out),Id(print),[IntLit(10)])]))])])]),Block([Continue]))])])])])]))])])"
    ...
    def test31(self):
        ...
        expect = "Program([ClassDecl(Id(testData),[MethodDecl(Id(loopTest),Instance,[param(Id(a),IntType),param(Id(v),IntType),param(Id(c),FloatType),param(Id(d),FloatType),param(Id(a),BoolType),param(Id(s),BoolType),param(Id(str1),StringType),param(Id(str2),StringType),param(Id(r1),ClassType(Id(Room))),param(Id(r2),ClassType(Id(Room)))],Block([For(Id(i),BinaryOp(==,BinaryOp(-,BinaryOp(+,Id(a),Id(c)),Id(d)),Id(f)),BinaryOp(+,Id(a),BinaryOp(/,BinaryOp(>=,Id(a),Id(d)),IntLit(32))),IntLit(1),Block([If(BinaryOp(>,Id(a),BinaryOp(-,Id(f),IntLit(1))),Block([Call(Id(Out),Id(print),[IntLit(10)])]),If(BinaryOp(<=,Id(a),IntLit(10)),Block([Return(FieldAccess(Id(Tester),Id($number)))])))])])]))])])"
    ...
    def test32(self):
        ...
        expect = "Program([ClassDecl(Id(testData),Id(PPL),[MethodDecl(Id(_LoopTest),Instance,[],Block([For(Id(incre),UnaryOp(-,IntLit(10)),BinaryOp(+,IntLit(22),Id(a)),UnaryOp(-,BinaryOp(+,IntLit(22),IntLit(5))),Block([Return(BinaryOp(!=,Id(a),BinaryOp(&&,IntLit(10),UnaryOp(!,Id(a)))))])])]))])])"
...
Class mainClass {
    ...
    Foreach (i In 1 .. n) {
        ...
        expect = r"""Program([ClassDecl(Id(mainClass),[MethodDecl(Id(main),Instance,[],Block([Call(Id(io),Id(print),[StringLit(\n=============================================================\n)]),Call(Id(io),Id(print),[StringLit(How many Classroom? )]),Call(Id(io),Id(getInt),[Id(n)]),AssignStmt(Id(sRoom),Id(n)),For(Id(i),IntLit(1),Id(n),IntLit(1),Block([ConstDecl(Id(name),StringType,None),Call(Id(io),Id(print),[StringLit(---------------------------------\n)]),Call(Id(io),Id(print),[BinaryOp(+.,StringLit(Input details for Classroom ),StringLit(:\n))]),Call(Id(io),Id(print),[StringLit(Input name of Classroom: )]),Call(Id(io),Id(fflush),[Id(stdin)]),Call(Id(io),Id(getline),[Id(name)]),Call(Id(ClassR),Id(setNameClassroom),[Id(name)])])])]))])])"""
...
Class mainClass {
    ...
    Foreach (i In 1 .. 10 By -b+a) {
        ...
        expect = r"""Program([ClassDecl(Id(mainClass),[MethodDecl(Id(main),Instance,[],Block([Call(Id(io),Id(print),[StringLit(\n=============================================================\n)]),Call(Id(io),Id(print),[StringLit(How many Classroom? )]),Call(Id(io),Id(getInt),[Id(n)]),AssignStmt(Id(sRoom),Id(n)),For(Id(i),IntLit(1),IntLit(10),BinaryOp(+,UnaryOp(-,Id(b)),Id(a)),Block([Call(Id(io),Id(print),[StringLit(---------------------------------\n)]),Call(Id(io),Id(print),[BinaryOp(+.,StringLit(Input details for Classroom ),StringLit(:\n))]),Call(Id(io),Id(print),[StringLit(Input name of Classroom: )]),Call(Id(io),Id(fflush),[Id(stdin)]),Call(Id(io),Id(getline),[Id(name)]),Call(Id(ClassR),Id(setNameClassroom),[Id(name)])])])]))])])"""
...
Class makeSchool {
     ...
     getNext() {
        ...
        expect = "Program([ClassDecl(Id(makeSchool),[MethodDecl(Id(main),Instance,[],Block([For(Id(i),IntLit(10),IntLit(1),IntLit(2),Block([ConstDecl(Id(new_Class),StringType,None),Call(Id(io),Id(fflush),[Id(stdin)]),Call(Id(io),Id(getline),[Id(new_Class)]),If(BinaryOp(!=,Id(new_Class),StringLit(-1)),Block([Call(Id(School),Id(updateClass),[Id(new_Class)])]),Block([Break]))])])])),MethodDecl(Id(getNext),Instance,[],Block([Return(Id(next))]))])])"
...
Class getStudent {
     main() {
        ...
        expect = "Program([ClassDecl(Id(getStudent),[MethodDecl(Id(main),Instance,[],Block([Call(Id(io),Id(getInt),[Id(n)]),For(Id(i),IntLit(0),Id(n),IntLit(1),Block([Call(Id(io),Id(fflush),[Id(stdin)]),Call(Id(io),Id(getBoolean),[Id(option)]),AssignStmt(Id(new_student),CallExpr(CallExpr(Id(School),Id(getNameClass),[BinaryOp(%,CallExpr(Id(range),Id(random),[]),FieldAccess(Id(School),Id(num_Class)))]),Id(getStudent),[Id(name),Id(id),Id(option)])),Call(Id(lass),Id(updateStudent),[Id(new_student)])])])]))])])"
